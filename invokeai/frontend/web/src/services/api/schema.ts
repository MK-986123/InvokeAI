...
export type components = {
    schemas: {
        ...
        InvocationOutputMap: {
            ...
            resample_banding_fix: components["schemas"]["LatentsOutput"];
        ...
        /**
         * Latent Resample Banding Fix
         * @description Run a short denoising pass to resample latents and reduce vertical/horizontal banding.
         */
        ResampleBandingFixInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * type
             * @default resample_banding_fix
             * @constant
             */
            type: "resample_banding_fix";
        };
        /**
         * Resize Latents
