        ...
        for step_index in range(num_scheduler_steps):
            ...
            for controlnet_extension in controlnet_extensions:
                controlnet_residuals.append(
                    controlnet_extension.run_controlnet(
                        ...
                        img=img,
                        img_ids=img_ids,
                        txt=pos_regional_prompting_extension.regional_text_conditioning.active_text_embeddings(),
                        txt_ids=pos_regional_prompting_extension.regional_text_conditioning.active_txt_ids(),
            ...
            if not math.isclose(step_cfg_scale, 1.0):
                ...
                neg_pred = model(
                    ...
                    txt=neg_regional_prompting_extension.regional_text_conditioning.active_text_embeddings(),
                    txt_ids=neg_regional_prompting_extension.regional_text_conditioning.active_txt_ids(),
